...
for (function (a) {
    ...
    foreground: "#000000"
			...
			for (c.addData(utf16to8(b.text)), c.make(), d = a("<table></table>").css("font-size", "0").css("width", b.width + "px").css("height", b.height + "px").css("border", "0px").css("border-collapse", "collapse").css("background-color", b.background), e = b.width / c.getModuleCount(), f = b.height / c.getModuleCount(), g = 0; g < c.getModuleCount() ; g++) {
