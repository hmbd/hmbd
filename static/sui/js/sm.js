...
+ function(window) {
    ...
    IScroll.prototype = {
        ...
        _move: function(e) {
            ...
            if (this.options.preventDefault) { // increases performance on Android? check!
                e.preventDefault();
            }
        ...
        _initIndicators: function() {
            ...
            // check if we can use array.map (wide compatibility and performance issues)
    ...
    Scroller.prototype = {
        ...
        _bindEventToDomWhenJs: function() {
            ...
            if (this.scroller) {
                ...
                // 实现native的scrollStart和scrollEnd
            }
        },
        scrollTop: function(top, dur) {
            if (this.scroller) {
...
+function($) {
    ...
    Router.prototype._animateElement = function($from, $to, direction) {
        // 可考虑如果入参不指定，那么尝试读取 $to 的属性，再没有再使用默认的
        // 考虑读取点击的链接上指定的方向
